...
# ACDS 18.0 614 win32 2020.03.11.22:55:51
# ----------------------------------------
...
# ----------------------------------------
# If clockSpeedUp is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "clockSpeedUp"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/clockSpeedUp.vo"
}
