...
//altmem_init CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" INIT_TO_ZERO="YES" NUMWORDS=16384 PORT_ROM_DATA_READY="PORT_UNUSED" ROM_READ_LATENCY=1 WIDTH=32 WIDTHAD=14 clock dataout init init_busy ram_address ram_wren
...
module btb (
	...
	btb_meminit_k6k	btb_meminit_k6k_component (
				.clock (clock),
				.init (init),
				.dataout (sub_wire0),
				.init_busy (sub_wire1),
